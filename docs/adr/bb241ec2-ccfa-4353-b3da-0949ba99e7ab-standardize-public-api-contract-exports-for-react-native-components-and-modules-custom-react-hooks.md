...
1. MUST: Custom React hooks MUST export a named contract using the 'use' prefix convention (e.g., useAuth)

## Policy Block

- MUST Custom React hooks MUST export a named contract using the 'use' prefix convention (e.g., useAuth)
