...
1. MUST: External authentication API calls MUST use axios as the HTTP client library for all authentication operations including login, registration, and token management

## Policy Block

- MUST External authentication API calls MUST use axios as the HTTP client library for all authentication operations including login, registration, and token management
