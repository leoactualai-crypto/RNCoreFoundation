...
1. MAY: Projects MAY use 'test' as an alias for 'it' where team conventions prefer explicit test nomenclature

## Policy Block

- MAY Projects MAY use 'test' as an alias for 'it' where team conventions prefer explicit test nomenclature
