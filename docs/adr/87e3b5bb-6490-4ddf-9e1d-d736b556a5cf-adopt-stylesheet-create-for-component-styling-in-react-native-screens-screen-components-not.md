# Adopt StyleSheet.create for Component Styling in React Native Screens: Screen Components Not
...
1. MUST_NOT: Screen components MUST NOT use inline style objects for static styling that could be defined in StyleSheet.create

## Policy Block

- MUST_NOT Screen components MUST NOT use inline style objects for static styling that could be defined in StyleSheet.create
