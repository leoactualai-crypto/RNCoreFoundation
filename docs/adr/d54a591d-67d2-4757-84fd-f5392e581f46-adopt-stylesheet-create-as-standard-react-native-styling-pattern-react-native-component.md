...
1. MUST: All React Native component files MUST define styles using StyleSheet.create() rather than plain JavaScript objects or inline style definitions

## Policy Block

- MUST All React Native component files MUST define styles using StyleSheet.create() rather than plain JavaScript objects or inline style definitions
