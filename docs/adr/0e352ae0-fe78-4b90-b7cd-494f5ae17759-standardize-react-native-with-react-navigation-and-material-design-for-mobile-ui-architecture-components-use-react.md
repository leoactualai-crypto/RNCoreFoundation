...
1. MUST: UI components MUST use react-native-paper for Material Design themed components including buttons, text inputs, cards, and surface elements.

## Policy Block

- MUST UI components MUST use react-native-paper for Material Design themed components including buttons, text inputs, cards, and surface elements.
