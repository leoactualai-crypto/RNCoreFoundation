...
1. MUST: Navigation parameter types MUST be defined using TypeScript interfaces that extend navigation param list types (e.g., RootStackParamList, MaterialBottomTabParamList).

## Policy Block

- MUST Navigation parameter types MUST be defined using TypeScript interfaces that extend navigation param list types (e.g., RootStackParamList, MaterialBottomTabParamList).
