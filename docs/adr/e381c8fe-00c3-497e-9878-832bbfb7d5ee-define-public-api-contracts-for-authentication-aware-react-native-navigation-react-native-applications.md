...
1. MUST: All React Native applications using @react-navigation/stack MUST define a RootStackParamList type contract that explicitly declares all navigation routes and their parameter types

## Policy Block

- MUST All React Native applications using @react-navigation/stack MUST define a RootStackParamList type contract that explicitly declares all navigation routes and their parameter types
