...
1. SHOULD: Test files SHOULD be co-located with the components they test, using the __tests__ directory convention

## Policy Block

- SHOULD Test files SHOULD be co-located with the components they test, using the __tests__ directory convention
