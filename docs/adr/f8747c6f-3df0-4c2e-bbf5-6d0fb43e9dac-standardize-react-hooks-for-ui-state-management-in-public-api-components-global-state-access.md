...
1. SHOULD: Global state access SHOULD use useSelector hook from react-redux for consistency across navigation and screen components

## Policy Block

- SHOULD Global state access SHOULD use useSelector hook from react-redux for consistency across navigation and screen components
