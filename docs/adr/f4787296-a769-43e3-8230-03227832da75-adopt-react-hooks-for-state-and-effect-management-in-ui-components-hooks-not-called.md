...
1. MUST_NOT: Hooks MUST_NOT be called conditionally or inside loops; they must be called at the top level of functional components

## Policy Block

- MUST_NOT Hooks MUST_NOT be called conditionally or inside loops; they must be called at the top level of functional components
