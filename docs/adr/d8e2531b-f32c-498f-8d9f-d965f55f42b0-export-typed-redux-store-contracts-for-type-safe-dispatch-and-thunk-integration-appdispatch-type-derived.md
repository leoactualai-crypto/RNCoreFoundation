...
1. SHOULD: AppDispatch type SHOULD be derived from typeof store.dispatch to ensure dispatch signatures remain synchronized with store configuration

## Policy Block

- SHOULD AppDispatch type SHOULD be derived from typeof store.dispatch to ensure dispatch signatures remain synchronized with store configuration
