...
1. SHOULD: Redux slice modules SHOULD export the reducer as a named export with '.reducer' suffix (e.g., profileSlice.reducer)

## Policy Block

- SHOULD Redux slice modules SHOULD export the reducer as a named export with '.reducer' suffix (e.g., profileSlice.reducer)
