...
1. SHOULD: Registration requests SHOULD include username, email, and password fields in the request body

## Policy Block

- SHOULD Registration requests SHOULD include username, email, and password fields in the request body
