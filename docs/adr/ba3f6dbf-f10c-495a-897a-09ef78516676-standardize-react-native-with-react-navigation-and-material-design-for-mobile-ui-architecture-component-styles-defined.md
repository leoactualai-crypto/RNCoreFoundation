...
1. MUST: Component styles MUST be defined using StyleSheet.create() with typed style objects rather than inline style objects.

## Policy Block

- MUST Component styles MUST be defined using StyleSheet.create() with typed style objects rather than inline style objects.
