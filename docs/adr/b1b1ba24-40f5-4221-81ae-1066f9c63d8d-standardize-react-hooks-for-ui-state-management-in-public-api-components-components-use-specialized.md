...
1. MAY: Components MAY use specialized hooks (useCallback) for callback memoization when passing functions to child components

## Policy Block

- MAY Components MAY use specialized hooks (useCallback) for callback memoization when passing functions to child components
