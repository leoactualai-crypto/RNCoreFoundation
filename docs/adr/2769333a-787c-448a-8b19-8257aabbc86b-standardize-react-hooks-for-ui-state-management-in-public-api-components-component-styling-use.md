...
1. MUST: Component styling MUST use StyleSheet.create for performance optimization and type safety

## Policy Block

- MUST Component styling MUST use StyleSheet.create for performance optimization and type safety
