...
1. MUST_NOT: Public API modules MUST NOT export internal implementation details, helper functions, or intermediate computation results unless explicitly intended for reuse

## Policy Block

- MUST_NOT Public API modules MUST NOT export internal implementation details, helper functions, or intermediate computation results unless explicitly intended for reuse
