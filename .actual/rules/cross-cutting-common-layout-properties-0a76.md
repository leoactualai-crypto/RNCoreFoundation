...
These rules are ALWAYS ACTIVE for all React Native screen components in the `/screens` directory and custom components that define visual presentation and layout containers.

### Rules

- **R-STYLESHEET-001** MUST: Common layout properties (flex, justifyContent, padding, margin) MUST be defined in StyleSheet objects rather than inline.
