...
1. MUST: All screen components MUST define their styles using StyleSheet.create() at the module level

## Policy Block

- MUST All screen components MUST define their styles using StyleSheet.create() at the module level
