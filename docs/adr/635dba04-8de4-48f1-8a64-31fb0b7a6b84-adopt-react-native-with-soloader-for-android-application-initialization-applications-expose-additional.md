...
1. MAY: Applications MAY expose additional public API contracts beyond the minimum ReactApplication interface requirements for custom initialization logic

## Policy Block

- MAY Applications MAY expose additional public API contracts beyond the minimum ReactApplication interface requirements for custom initialization logic
