...
1. SHOULD: Environment-sensitive configuration SHOULD be isolated to store initialization rather than distributed across reducer logic

## Policy Block

- SHOULD Environment-sensitive configuration SHOULD be isolated to store initialization rather than distributed across reducer logic
