...
1. SHOULD: Typography styles (fontSize, fontWeight, color) SHOULD be centralized in StyleSheet definitions

## Policy Block

- SHOULD Typography styles (fontSize, fontWeight, color) SHOULD be centralized in StyleSheet definitions
