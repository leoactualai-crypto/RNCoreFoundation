...
1. SHOULD: Icons SHOULD use react-native-vector-icons/MaterialCommunityIcons for consistent iconography across the application.

## Policy Block

- SHOULD Icons SHOULD use react-native-vector-icons/MaterialCommunityIcons for consistent iconography across the application.
