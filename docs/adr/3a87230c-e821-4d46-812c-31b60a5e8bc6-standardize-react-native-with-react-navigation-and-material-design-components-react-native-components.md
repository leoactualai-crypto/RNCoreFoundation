...
1. MUST: All React Native components MUST use 'react' and 'react-native' as core framework dependencies for component definition and platform APIs

## Policy Block

- MUST All React Native components MUST use 'react' and 'react-native' as core framework dependencies for component definition and platform APIs
