...
1. MUST: Components accessing Redux store state MUST use the useSelector hook from react-redux rather than connect HOC.

## Policy Block

- MUST Components accessing Redux store state MUST use the useSelector hook from react-redux rather than connect HOC.
