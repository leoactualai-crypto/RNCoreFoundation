...
1. SHOULD: Developer support mode SHOULD be configurable through getUseDeveloperSupport() method returning BuildConfig.DEBUG or equivalent

## Policy Block

- SHOULD Developer support mode SHOULD be configurable through getUseDeveloperSupport() method returning BuildConfig.DEBUG or equivalent
