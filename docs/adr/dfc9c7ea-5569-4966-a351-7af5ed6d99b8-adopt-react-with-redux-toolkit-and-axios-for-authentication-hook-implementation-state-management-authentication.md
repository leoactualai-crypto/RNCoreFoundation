...
1. MUST: State management for authentication MUST be implemented using @reduxjs/toolkit

## Policy Block

- MUST State management for authentication MUST be implemented using @reduxjs/toolkit
