...
1. MAY: Components MAY create custom hooks to extract and share stateful logic across multiple components when patterns emerge

## Policy Block

- MAY Components MAY create custom hooks to extract and share stateful logic across multiple components when patterns emerge
