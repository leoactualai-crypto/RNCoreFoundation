...
1. MUST: Components requiring global state access MUST use useSelector hook from react-redux rather than connect() higher-order component pattern.

## Policy Block

- MUST Components requiring global state access MUST use useSelector hook from react-redux rather than connect() higher-order component pattern.
