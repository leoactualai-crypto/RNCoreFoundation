...
1. SHOULD: Template test files SHOULD provide minimal example implementations that demonstrate syntax without imposing specific assertion patterns

## Policy Block

- SHOULD Template test files SHOULD provide minimal example implementations that demonstrate syntax without imposing specific assertion patterns
