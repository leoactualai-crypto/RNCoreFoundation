...
1. SHOULD: Components SHOULD access styles via the created stylesheet object (e.g., styles.container) rather than destructuring or copying style objects

## Policy Block

- SHOULD Components SHOULD access styles via the created stylesheet object (e.g., styles.container) rather than destructuring or copying style objects
