...
1. MUST: Screen components MUST export named functions or constants as public API contracts (e.g., LoginScreen, ChatScreen, AuthStackNavigator)

## Policy Block

- MUST Screen components MUST export named functions or constants as public API contracts (e.g., LoginScreen, ChatScreen, AuthStackNavigator)
