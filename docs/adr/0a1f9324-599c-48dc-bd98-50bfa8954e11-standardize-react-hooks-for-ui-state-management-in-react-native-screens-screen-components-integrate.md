...
1. MAY: Screen components MAY integrate specialized libraries (react-native-gifted-chat, react-native-safe-area-context) when standard components are insufficient

## Policy Block

- MAY Screen components MAY integrate specialized libraries (react-native-gifted-chat, react-native-safe-area-context) when standard components are insufficient
