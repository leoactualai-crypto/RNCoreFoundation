...
1. SHOULD: Applications SHOULD implement getUseDeveloperSupport() method to control developer mode features and debugging capabilities based on build configuration

## Policy Block

- SHOULD Applications SHOULD implement getUseDeveloperSupport() method to control developer mode features and debugging capabilities based on build configuration
