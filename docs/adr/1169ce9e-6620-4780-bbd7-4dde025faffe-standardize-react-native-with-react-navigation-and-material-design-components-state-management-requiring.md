...
1. MUST: State management requiring Redux patterns MUST use '@reduxjs/toolkit' for slice definitions and store configuration

## Policy Block

- MUST State management requiring Redux patterns MUST use '@reduxjs/toolkit' for slice definitions and store configuration
