...
1. MUST: All screen components MUST define styles using StyleSheet.create() with typed style objects rather than inline style objects or external CSS.

## Policy Block

- MUST All screen components MUST define styles using StyleSheet.create() with typed style objects rather than inline style objects or external CSS.
