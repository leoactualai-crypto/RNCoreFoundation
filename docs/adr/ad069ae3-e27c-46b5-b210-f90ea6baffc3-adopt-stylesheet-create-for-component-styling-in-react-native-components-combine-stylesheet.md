# Adopt StyleSheet.create() for Component Styling in React Native: Components Combine Stylesheet
...
1. MAY: Components MAY combine StyleSheet-defined styles with dynamic style properties when runtime computation is required

## Policy Block

- MAY Components MAY combine StyleSheet-defined styles with dynamic style properties when runtime computation is required
