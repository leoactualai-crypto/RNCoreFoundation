...
1. MUST: Secure credential storage MUST use 'react-native-secure-storage' for persisting authentication tokens and sensitive data

## Policy Block

- MUST Secure credential storage MUST use 'react-native-secure-storage' for persisting authentication tokens and sensitive data
