...
1. MUST: Login requests MUST send identifier and password fields in the request body

## Policy Block

- MUST Login requests MUST send identifier and password fields in the request body
