...
1. MAY: Navigation type definitions MAY define ParamList types to enforce type-safe navigation parameters across screens

## Policy Block

- MAY Navigation type definitions MAY define ParamList types to enforce type-safe navigation parameters across screens
