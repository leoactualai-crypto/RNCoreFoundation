...
1. MUST: Authentication hooks MUST expose useAuth as the public contract interface

## Policy Block

- MUST Authentication hooks MUST expose useAuth as the public contract interface
