...
1. MUST: Context providers MUST export named context objects with 'Context' suffix (e.g., UserContext, AuthContext)

## Policy Block

- MUST Context providers MUST export named context objects with 'Context' suffix (e.g., UserContext, AuthContext)
