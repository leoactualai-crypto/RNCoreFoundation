...
1. SHOULD: UI interaction state SHOULD be managed using React hooks (useState, useEffect, useMemo, useCallback, useSelector) rather than class component lifecycle methods

## Policy Block

- SHOULD UI interaction state SHOULD be managed using React hooks (useState, useEffect, useMemo, useCallback, useSelector) rather than class component lifecycle methods
