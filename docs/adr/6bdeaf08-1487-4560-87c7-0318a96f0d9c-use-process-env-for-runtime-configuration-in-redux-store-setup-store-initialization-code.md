...
1. MUST_NOT: Store initialization code MUST NOT access process.env variables containing secrets or credentials directly

## Policy Block

- MUST_NOT Store initialization code MUST NOT access process.env variables containing secrets or credentials directly
