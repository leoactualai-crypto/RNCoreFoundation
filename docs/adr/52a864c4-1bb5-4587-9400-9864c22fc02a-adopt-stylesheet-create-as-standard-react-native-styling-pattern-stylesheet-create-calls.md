...
1. MUST: StyleSheet.create() calls MUST be placed at the module level (outside component functions) to ensure style objects are created once and reused across renders

## Policy Block

- MUST StyleSheet.create() calls MUST be placed at the module level (outside component functions) to ensure style objects are created once and reused across renders
