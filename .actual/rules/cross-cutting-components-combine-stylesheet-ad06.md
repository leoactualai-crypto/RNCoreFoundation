...
- **R-STYLESHEET-001** MAY: Components MAY combine StyleSheet-defined styles with dynamic style properties when runtime computation is required.
...
# Find React Native imports without StyleSheet.create()
