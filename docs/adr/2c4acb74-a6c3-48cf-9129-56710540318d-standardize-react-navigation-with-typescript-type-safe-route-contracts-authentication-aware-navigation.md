...
1. SHOULD: Authentication-aware navigation SHOULD integrate with Redux state via useSelector and custom hooks (e.g., useAuth)

## Policy Block

- SHOULD Authentication-aware navigation SHOULD integrate with Redux state via useSelector and custom hooks (e.g., useAuth)
