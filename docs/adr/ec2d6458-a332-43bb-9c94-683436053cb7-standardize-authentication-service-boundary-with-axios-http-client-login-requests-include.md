...
1. MUST: Login requests MUST include identifier and password fields in the request payload

## Policy Block

- MUST Login requests MUST include identifier and password fields in the request payload
