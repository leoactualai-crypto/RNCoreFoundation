...
1. MUST: Applications MUST use com.facebook.react.PackageList to declare and initialize React Native packages with their native dependencies

## Policy Block

- MUST Applications MUST use com.facebook.react.PackageList to declare and initialize React Native packages with their native dependencies
