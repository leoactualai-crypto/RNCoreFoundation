...
1. SHOULD: Applications SHOULD use PackageList for automatic discovery and registration of React Native packages

## Policy Block

- SHOULD Applications SHOULD use PackageList for automatic discovery and registration of React Native packages
