...
1. MUST: Components accessing global state MUST use useSelector from react-redux rather than direct store access

## Policy Block

- MUST Components accessing global state MUST use useSelector from react-redux rather than direct store access
