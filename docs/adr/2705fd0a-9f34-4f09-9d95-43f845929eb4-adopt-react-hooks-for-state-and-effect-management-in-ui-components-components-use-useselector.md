...
1. SHOULD: Components SHOULD use useSelector from react-redux for accessing global state rather than direct store access

## Policy Block

- SHOULD Components SHOULD use useSelector from react-redux for accessing global state rather than direct store access
