...
1. MUST: Style objects created with StyleSheet.create MUST be defined as constants outside the component render function

## Policy Block

- MUST Style objects created with StyleSheet.create MUST be defined as constants outside the component render function
