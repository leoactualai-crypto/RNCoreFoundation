...
1. MUST: Test files MUST be placed in __tests__ directories and follow the naming pattern <ComponentName>-test.tsx

## Policy Block

- MUST Test files MUST be placed in __tests__ directories and follow the naming pattern <ComponentName>-test.tsx
