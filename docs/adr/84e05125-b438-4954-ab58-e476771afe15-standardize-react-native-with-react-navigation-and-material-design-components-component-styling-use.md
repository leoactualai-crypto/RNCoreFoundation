...
1. MUST: Component styling MUST use StyleSheet.create() from 'react-native' for style definitions to ensure optimization and type safety

## Policy Block

- MUST Component styling MUST use StyleSheet.create() from 'react-native' for style definitions to ensure optimization and type safety
