...
1. MAY: The useAuth() hook MAY expose additional authentication methods such as login, logout, and token refresh alongside state

## Policy Block

- MAY The useAuth() hook MAY expose additional authentication methods such as login, logout, and token refresh alongside state
