...
1. MUST: Test files MUST be placed in __tests__ directories with the -test.tsx or -test.ts suffix pattern

## Policy Block

- MUST Test files MUST be placed in __tests__ directories with the -test.tsx or -test.ts suffix pattern
