...
1. SHOULD: Components SHOULD use useMemo for expensive computations or derived state that depends on specific dependencies

## Policy Block

- SHOULD Components SHOULD use useMemo for expensive computations or derived state that depends on specific dependencies
