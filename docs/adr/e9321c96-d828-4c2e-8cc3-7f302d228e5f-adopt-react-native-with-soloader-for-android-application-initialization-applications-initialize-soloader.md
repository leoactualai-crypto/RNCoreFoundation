...
1. MUST: Applications MUST initialize SoLoader during onCreate lifecycle method using SoLoader.init() to establish secure native library loading before any native code execution

## Policy Block

- MUST Applications MUST initialize SoLoader during onCreate lifecycle method using SoLoader.init() to establish secure native library loading before any native code execution
