...
1. MAY: Configuration values such as BASE_URL MAY be imported from a centralized config module

## Policy Block

- MAY Configuration values such as BASE_URL MAY be imported from a centralized config module
