...
1. SHOULD: AppThunk type SHOULD be parameterized to accept return type and argument types for flexible async action creators

## Policy Block

- SHOULD AppThunk type SHOULD be parameterized to accept return type and argument types for flexible async action creators
