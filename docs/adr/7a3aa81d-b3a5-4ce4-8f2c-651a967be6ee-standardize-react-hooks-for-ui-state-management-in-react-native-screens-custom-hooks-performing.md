...
1. MUST: Custom hooks performing side effects (HTTP requests, storage operations) MUST handle error states and loading states explicitly

## Policy Block

- MUST Custom hooks performing side effects (HTTP requests, storage operations) MUST handle error states and loading states explicitly
