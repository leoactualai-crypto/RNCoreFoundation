...
1. SHOULD: HTTP client configuration SHOULD be centralized in a config module to enable BASE_URL management

## Policy Block

- SHOULD HTTP client configuration SHOULD be centralized in a config module to enable BASE_URL management
