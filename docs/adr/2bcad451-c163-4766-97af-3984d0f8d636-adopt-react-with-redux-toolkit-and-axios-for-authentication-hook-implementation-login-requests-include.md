...
1. SHOULD: Login requests SHOULD include identifier and password fields in the request body

## Policy Block

- SHOULD Login requests SHOULD include identifier and password fields in the request body
