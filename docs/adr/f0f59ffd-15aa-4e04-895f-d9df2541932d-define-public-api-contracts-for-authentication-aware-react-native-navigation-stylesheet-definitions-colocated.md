...
1. SHOULD: StyleSheet definitions SHOULD be colocated with components and use consistent design tokens (Colors.lighter, Colors.white, etc.) for maintainable styling

## Policy Block

- SHOULD StyleSheet definitions SHOULD be colocated with components and use consistent design tokens (Colors.lighter, Colors.white, etc.) for maintainable styling
