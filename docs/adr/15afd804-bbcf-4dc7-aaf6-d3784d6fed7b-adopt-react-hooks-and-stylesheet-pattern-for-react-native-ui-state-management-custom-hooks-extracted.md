...
1. SHOULD: Custom hooks SHOULD be extracted for reusable stateful logic that spans multiple components, following the useXxx naming convention (e.g., useAuth).

## Policy Block

- SHOULD Custom hooks SHOULD be extracted for reusable stateful logic that spans multiple components, following the useXxx naming convention (e.g., useAuth).
