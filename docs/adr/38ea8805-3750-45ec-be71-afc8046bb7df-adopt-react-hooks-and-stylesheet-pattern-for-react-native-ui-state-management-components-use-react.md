...
1. MUST: UI components MUST use react-native-paper components for Material Design elements rather than implementing custom UI primitives.

## Policy Block

- MUST UI components MUST use react-native-paper components for Material Design elements rather than implementing custom UI primitives.
