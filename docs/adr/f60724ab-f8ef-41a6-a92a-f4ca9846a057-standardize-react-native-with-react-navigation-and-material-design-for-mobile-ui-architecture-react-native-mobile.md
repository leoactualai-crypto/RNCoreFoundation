...
1. MUST: All React Native mobile screens MUST use @react-navigation for navigation implementation, including stack, drawer, and tab navigation patterns.

## Policy Block

- MUST All React Native mobile screens MUST use @react-navigation for navigation implementation, including stack, drawer, and tab navigation patterns.
