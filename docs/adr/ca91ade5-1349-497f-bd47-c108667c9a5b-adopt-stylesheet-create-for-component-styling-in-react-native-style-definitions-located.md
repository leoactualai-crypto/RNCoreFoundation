...
1. SHOULD: Style definitions SHOULD be co-located with their component definitions in the same file

## Policy Block

- SHOULD Style definitions SHOULD be co-located with their component definitions in the same file
