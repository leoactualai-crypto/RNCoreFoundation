# Adopt React Hooks for State and Effect Management in UI Components: Components Use Usememo
...
- **R-HOOKS-001** SHOULD: Components SHOULD use useMemo for expensive computations or derived state that depends on specific dependencies.
...
- Dependency arrays in useEffect and useMemo are properly documented with inline comments explaining inclusion or intentional omission
