...
1. MUST_NOT: Applications MUST NOT enable native exopackage mode in SoLoader.init() unless explicitly required for development optimization

## Policy Block

- MUST_NOT Applications MUST NOT enable native exopackage mode in SoLoader.init() unless explicitly required for development optimization
