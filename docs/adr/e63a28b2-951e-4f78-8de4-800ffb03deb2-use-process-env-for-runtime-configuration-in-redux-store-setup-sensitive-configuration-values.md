...
1. SHOULD: Sensitive configuration values SHOULD be injected through configuration modules rather than read directly in store setup

## Policy Block

- SHOULD Sensitive configuration values SHOULD be injected through configuration modules rather than read directly in store setup
