...
1. SHOULD: Screen components SHOULD export typed navigation contracts that define their public API surface for navigation and parameter passing.

## Policy Block

- SHOULD Screen components SHOULD export typed navigation contracts that define their public API surface for navigation and parameter passing.
