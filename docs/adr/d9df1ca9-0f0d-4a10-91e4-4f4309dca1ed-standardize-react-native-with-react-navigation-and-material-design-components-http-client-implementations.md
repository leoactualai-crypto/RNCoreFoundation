...
1. SHOULD: HTTP client implementations SHOULD use 'axios' for API communication and request/response handling

## Policy Block

- SHOULD HTTP client implementations SHOULD use 'axios' for API communication and request/response handling
