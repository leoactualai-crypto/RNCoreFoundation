...
1. SHOULD: Base URL configuration SHOULD be externalized to a config module to support environment-specific service endpoints

## Policy Block

- SHOULD Base URL configuration SHOULD be externalized to a config module to support environment-specific service endpoints
