...
1. SHOULD: Components exposing public contracts SHOULD use TypeScript interfaces to define navigation parameter types (RootStackParamList)

## Policy Block

- SHOULD Components exposing public contracts SHOULD use TypeScript interfaces to define navigation parameter types (RootStackParamList)
