...
1. MUST: Applications MUST provide a ReactNativeHost instance through getReactNativeHost() method for managing React instance lifecycle

## Policy Block

- MUST Applications MUST provide a ReactNativeHost instance through getReactNativeHost() method for managing React instance lifecycle
