...
1. MUST: Component modules that serve as screen entry points MUST export a single named component matching the file purpose (e.g., ChatScreen, LoginScreen, SplashScreen)

## Policy Block

- MUST Component modules that serve as screen entry points MUST export a single named component matching the file purpose (e.g., ChatScreen, LoginScreen, SplashScreen)
