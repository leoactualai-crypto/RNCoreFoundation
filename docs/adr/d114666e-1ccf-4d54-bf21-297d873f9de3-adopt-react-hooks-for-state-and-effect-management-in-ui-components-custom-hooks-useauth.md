...
1. MUST: Custom hooks (e.g., useAuth) MUST encapsulate reusable stateful logic and compose built-in hooks following React's Rules of Hooks

## Policy Block

- MUST Custom hooks (e.g., useAuth) MUST encapsulate reusable stateful logic and compose built-in hooks following React's Rules of Hooks
