...
These rules are ALWAYS ACTIVE for all Redux store configuration and module files in the application, particularly template/src/store/ and any files exporting store contracts, reducers, or thunk actions.

### Rules

- **R-REDUX-001** MUST: Store modules MUST export typed AppDispatch and AppThunk contracts for type-safe dispatch operations.
