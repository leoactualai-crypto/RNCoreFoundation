...
1. MUST: All navigation stacks MUST define TypeScript parameter list types (e.g., RootStackParamList) that declare screen names and their parameter shapes

## Policy Block

- MUST All navigation stacks MUST define TypeScript parameter list types (e.g., RootStackParamList) that declare screen names and their parameter shapes
