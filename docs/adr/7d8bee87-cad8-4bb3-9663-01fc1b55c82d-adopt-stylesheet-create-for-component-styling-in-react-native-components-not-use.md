...
1. MUST_NOT: Components MUST NOT use inline style objects directly in JSX without StyleSheet.create() optimization

## Policy Block

- MUST_NOT Components MUST NOT use inline style objects directly in JSX without StyleSheet.create() optimization
