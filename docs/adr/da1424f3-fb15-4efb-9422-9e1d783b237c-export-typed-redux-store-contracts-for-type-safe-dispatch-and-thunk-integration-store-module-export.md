...
1. MUST: The store module MUST export typed contracts including AppDispatch, AppThunk, and the store instance to enable type-safe integration across the application

## Policy Block

- MUST The store module MUST export typed contracts including AppDispatch, AppThunk, and the store instance to enable type-safe integration across the application
