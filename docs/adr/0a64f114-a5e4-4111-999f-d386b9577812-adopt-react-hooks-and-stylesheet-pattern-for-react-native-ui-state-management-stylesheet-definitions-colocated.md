...
1. SHOULD: StyleSheet definitions SHOULD be colocated with their component definitions at the bottom of the file, using descriptive style names that reflect semantic purpose.

## Policy Block

- SHOULD StyleSheet definitions SHOULD be colocated with their component definitions at the bottom of the file, using descriptive style names that reflect semantic purpose.
