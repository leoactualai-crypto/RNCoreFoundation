...
1. MUST_NOT: Components MUST NOT directly import or instantiate authentication services; all authentication operations MUST flow through the useAuth() hook interface

## Policy Block

- MUST_NOT Components MUST NOT directly import or instantiate authentication services; all authentication operations MUST flow through the useAuth() hook interface
