...
1. SHOULD: Design system modules (colors.ts, spacing.ts, typography.ts, buttons.ts) SHOULD export granular named constants (e.g., black, darkestGray, base, text) rather than single aggregate objects to enable tree-shaking

## Policy Block

- SHOULD Design system modules (colors.ts, spacing.ts, typography.ts, buttons.ts) SHOULD export granular named constants (e.g., black, darkestGray, base, text) rather than single aggregate objects to enable tree-shaking
