...
1. MUST: Navigation implementations MUST use '@react-navigation/native' as the base navigation library, with '@react-navigation/stack', '@react-navigation/drawer', or '@react-navigation/material-bottom-tabs' for specific navigation patterns

## Policy Block

- MUST Navigation implementations MUST use '@react-navigation/native' as the base navigation library, with '@react-navigation/stack', '@react-navigation/drawer', or '@react-navigation/material-bottom-tabs' for specific navigation patterns
