...
1. MUST: External API calls MUST be performed using axios HTTP client with explicit endpoint configuration from centralized config

## Policy Block

- MUST External API calls MUST be performed using axios HTTP client with explicit endpoint configuration from centralized config
