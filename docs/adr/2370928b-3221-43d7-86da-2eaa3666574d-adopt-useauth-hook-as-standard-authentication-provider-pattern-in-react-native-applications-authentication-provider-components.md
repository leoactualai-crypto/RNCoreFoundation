...
1. SHOULD: Authentication provider components SHOULD be placed at the root level of the React Native application, above navigation containers

## Policy Block

- SHOULD Authentication provider components SHOULD be placed at the root level of the React Native application, above navigation containers
