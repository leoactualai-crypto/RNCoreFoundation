...
1. SHOULD: Native exopackage mode SHOULD be explicitly configured in SoLoader.init() call to control native library packaging strategy

## Policy Block

- SHOULD Native exopackage mode SHOULD be explicitly configured in SoLoader.init() call to control native library packaging strategy
