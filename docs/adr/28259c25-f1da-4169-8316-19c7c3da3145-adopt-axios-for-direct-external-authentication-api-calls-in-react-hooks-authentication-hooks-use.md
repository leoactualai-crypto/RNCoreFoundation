...
1. MUST: Authentication hooks MUST use axios for HTTP POST requests to external authentication endpoints

## Policy Block

- MUST Authentication hooks MUST use axios for HTTP POST requests to external authentication endpoints
