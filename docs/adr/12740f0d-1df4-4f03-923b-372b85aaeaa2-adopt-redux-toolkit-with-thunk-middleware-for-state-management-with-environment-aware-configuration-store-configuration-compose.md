...
1. MUST: Store configuration MUST compose state through a rootReducer pattern that aggregates domain-specific reducers

## Policy Block

- MUST Store configuration MUST compose state through a rootReducer pattern that aggregates domain-specific reducers
