...
1. SHOULD: Components SHOULD use useCallback to memoize event handlers and callbacks passed to child components to prevent unnecessary re-renders

## Policy Block

- SHOULD Components SHOULD use useCallback to memoize event handlers and callbacks passed to child components to prevent unnecessary re-renders
