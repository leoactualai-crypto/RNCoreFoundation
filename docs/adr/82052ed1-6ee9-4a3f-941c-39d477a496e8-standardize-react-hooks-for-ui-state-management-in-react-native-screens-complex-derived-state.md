...
1. SHOULD: Complex derived state or memoized callbacks SHOULD use useMemo and useCallback to optimize re-render performance

## Policy Block

- SHOULD Complex derived state or memoized callbacks SHOULD use useMemo and useCallback to optimize re-render performance
