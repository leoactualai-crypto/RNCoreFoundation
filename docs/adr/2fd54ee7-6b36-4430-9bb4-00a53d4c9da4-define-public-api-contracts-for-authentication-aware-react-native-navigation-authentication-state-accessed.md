...
1. MUST: Authentication state MUST be accessed through a centralized useAuth() hook pattern to ensure consistent authentication context across navigation flows

## Policy Block

- MUST Authentication state MUST be accessed through a centralized useAuth() hook pattern to ensure consistent authentication context across navigation flows
