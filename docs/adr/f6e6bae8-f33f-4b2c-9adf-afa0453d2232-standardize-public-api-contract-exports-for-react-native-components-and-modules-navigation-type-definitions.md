...
1. MUST: Navigation type definitions MUST be exported as named TypeScript types with ParamList suffix (e.g., RootStackParamList, MaterialBottomTabParamList, TopicDrawerStackParamList)

## Policy Block

- MUST Navigation type definitions MUST be exported as named TypeScript types with ParamList suffix (e.g., RootStackParamList, MaterialBottomTabParamList, TopicDrawerStackParamList)
