...
1. MUST: Components performing side effects (API calls, subscriptions, storage operations) MUST use the useEffect hook with appropriate dependency arrays.

## Policy Block

- MUST Components performing side effects (API calls, subscriptions, storage operations) MUST use the useEffect hook with appropriate dependency arrays.
