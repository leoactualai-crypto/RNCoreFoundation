...
1. MUST: Navigation-aware components MUST use @react-navigation/stack or @react-navigation/native navigation primitives

## Policy Block

- MUST Navigation-aware components MUST use @react-navigation/stack or @react-navigation/native navigation primitives
