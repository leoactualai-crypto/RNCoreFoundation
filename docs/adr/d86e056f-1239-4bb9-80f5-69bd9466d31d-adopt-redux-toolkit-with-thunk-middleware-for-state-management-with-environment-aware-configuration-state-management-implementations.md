...
1. MUST: State management implementations MUST use @reduxjs/toolkit as the primary Redux abstraction layer

## Policy Block

- MUST State management implementations MUST use @reduxjs/toolkit as the primary Redux abstraction layer
