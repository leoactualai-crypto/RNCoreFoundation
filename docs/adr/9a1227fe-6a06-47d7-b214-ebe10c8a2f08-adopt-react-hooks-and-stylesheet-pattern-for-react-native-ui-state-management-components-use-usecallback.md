...
1. SHOULD: Components SHOULD use useCallback to memoize event handlers and useMemo to memoize computed values when passed as props to child components to prevent unnecessary re-renders.

## Policy Block

- SHOULD Components SHOULD use useCallback to memoize event handlers and useMemo to memoize computed values when passed as props to child components to prevent unnecessary re-renders.
