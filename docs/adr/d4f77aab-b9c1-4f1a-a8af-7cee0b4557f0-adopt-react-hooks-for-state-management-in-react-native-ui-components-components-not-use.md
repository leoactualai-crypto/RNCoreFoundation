...
1. MUST_NOT: Components MUST NOT use class-based lifecycle methods (componentDidMount, componentDidUpdate) in new code; use functional components with hooks instead.

## Policy Block

- MUST_NOT Components MUST NOT use class-based lifecycle methods (componentDidMount, componentDidUpdate) in new code; use functional components with hooks instead.
