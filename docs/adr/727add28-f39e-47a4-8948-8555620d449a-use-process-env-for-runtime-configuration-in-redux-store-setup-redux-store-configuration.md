...
1. MUST: Redux store configuration MUST read NODE_ENV from process.env to determine development vs production behavior

## Policy Block

- MUST Redux store configuration MUST read NODE_ENV from process.env to determine development vs production behavior
