...
1. SHOULD: Test descriptions passed to 'it' blocks SHOULD use lowercase strings describing the expected behavior

## Policy Block

- SHOULD Test descriptions passed to 'it' blocks SHOULD use lowercase strings describing the expected behavior
