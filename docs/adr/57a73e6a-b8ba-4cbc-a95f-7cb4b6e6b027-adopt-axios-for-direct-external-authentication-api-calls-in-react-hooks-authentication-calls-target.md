...
1. MUST: Authentication API calls MUST target BASE_URL-prefixed endpoints (/auth/local, /auth/local/register)

## Policy Block

- MUST Authentication API calls MUST target BASE_URL-prefixed endpoints (/auth/local, /auth/local/register)
