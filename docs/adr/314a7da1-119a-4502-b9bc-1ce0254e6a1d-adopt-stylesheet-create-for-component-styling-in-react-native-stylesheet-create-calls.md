# Adopt StyleSheet.create() for Component Styling in React Native: Stylesheet Create Calls
...
1. MUST: StyleSheet.create() calls MUST be placed at the module level, outside of component render functions

## Policy Block

- MUST StyleSheet.create() calls MUST be placed at the module level, outside of component render functions
