...
1. MUST: Test cases in React Native projects MUST be declared using the 'it' function with a descriptive string label and callback function

## Policy Block

- MUST Test cases in React Native projects MUST be declared using the 'it' function with a descriptive string label and callback function
