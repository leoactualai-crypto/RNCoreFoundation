...
1. MUST: UI components MUST use useState for managing local component state including form inputs, UI toggles, and transient interaction data

## Policy Block

- MUST UI components MUST use useState for managing local component state including form inputs, UI toggles, and transient interaction data
