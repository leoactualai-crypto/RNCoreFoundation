# Adopt StyleSheet.create() for Component Styling in React Native: Components Not Use

These rules are ALWAYS ACTIVE for all React Native functional and class components, including navigation components (drawer, stack, tab navigators), screen components, reusable UI components, and layout containers and wrappers.

### Rules

- **R-RN-STYLE-001** MUST_NOT: Components MUST NOT use inline style objects directly in JSX without StyleSheet.create() optimization.
...
# Count React Native component files that don't use StyleSheet.create()
