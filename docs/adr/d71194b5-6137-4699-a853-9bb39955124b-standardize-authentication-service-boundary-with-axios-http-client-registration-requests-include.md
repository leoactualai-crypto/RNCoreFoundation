...
1. MUST: Registration requests MUST include username, email, and password fields in the request payload

## Policy Block

- MUST Registration requests MUST include username, email, and password fields in the request payload
