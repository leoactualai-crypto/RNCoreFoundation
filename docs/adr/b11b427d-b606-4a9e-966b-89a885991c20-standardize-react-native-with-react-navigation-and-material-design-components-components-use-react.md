...
1. SHOULD: UI components SHOULD use 'react-native-paper' for Material Design components and theming to maintain consistent visual design language

## Policy Block

- SHOULD UI components SHOULD use 'react-native-paper' for Material Design components and theming to maintain consistent visual design language
